...
export const modeAllowedForActiveLayer = (activeLayer: LayerId, mode: RealmMapMode): boolean => {
  if (activeLayer === "terrain") return mode === "pan" || mode === "cell-select" || mode === "cell-region" || mode === "cell-erase" || mode === "grab";
  if (activeLayer === "region") return mode === "pan" || mode === "cell-select" || mode === "cell-region" || mode === "cell-erase" || mode === "grab" || mode === "shape";
