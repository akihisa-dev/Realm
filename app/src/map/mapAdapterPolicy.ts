...
export const modeAllowedForActiveLayer = (activeLayer: LayerId, explicit: boolean, mode: RealmMapMode): boolean => {
  if (!explicit) return true;
  if (activeLayer === "terrain") return mode === "pan" || mode === "cell-select" || mode === "cell-erase" || mode === "grab" || mode === "shape";
