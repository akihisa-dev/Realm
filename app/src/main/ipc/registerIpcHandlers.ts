...
export const REALM_IPC_CHANNELS = [
  "realm:listProjects", "realm:createProject", "realm:openProject", "realm:importProject", "realm:exportProject", "realm:writeArtifact", "realm:saveProject", "realm:updateProjectSettings", "realm:createFeature", "realm:createFeaturesBatch", "realm:reviseFeature", "realm:reviseFeaturesBatch", "realm:deleteFeature", "realm:deleteFeaturesBatch", "realm:setFeaturesLocked", "realm:importAsset", "realm:importAssetsBatch", "realm:readAsset", "realm:deleteAsset", "realm:deleteAssetsBatch", "realm:replaceMapShapes", "realm:applyCellAttributes", "realm:moveRegionCells", "realm:viewCellAttributes", "realm:undoProject", "realm:redoProject", "realm:closeProject", "realm:getOpenProject", "realm:chooseTransferPath", "realm:chooseArtifactPath",
] as const;
