...
const emptySnapshot: RealmSnapshot = { formatVersion: 12, path: "browser://test.realmmap", world: { id: "world-test", name: "テスト世界" }, layers: { terrain: [], regions: [], objects: [] }, assets: [], settings: { themeId: "ink", showGrid: true, exportScale: 2, exportExtent: "world", canvasWidth: 2048, canvasHeight: 1024, gridKind: "graticule", gridColor: "#687784", gridWidth: 1, gridSpacing: 10, themeOverrides: {} }, canUndo: false, canRedo: false };
