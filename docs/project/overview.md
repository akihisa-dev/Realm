...
- The fixed 512 by 256 editing grid is visible before any terrain is drawn, starts at a scale where cells are large enough to edit, and remains independent from persistent terrain cells and transient brush selection.
