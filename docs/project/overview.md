...
左ツールレールには共通の編集用「描く」「消す」「掴む」をアイコンだけで表示し、領域レイヤーでは追加で「シェイピング」を表示します。最下部には「新規作成」を配置します。新規作成では現在の世界を残したまま、空の新しい世界を開きます。
...
- 左ツールレールには共通の「描く」「消す」「掴む」を表示し、領域レイヤーでは「シェイピング」も選べる。最下部の「新規作成」で現在の世界を残したまま空の新しい世界を開ける。共通に見える編集操作もactive layer固有のハンドラーと保存コマンドへ振り分ける
