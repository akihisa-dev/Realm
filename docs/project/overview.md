...
左ツールレールには編集用の「描く」「消す」「掴む」の3つをアイコンだけで表示し、最下部に「新規作成」を配置します。新規作成では現在の世界を残したまま、空の新しい世界を開きます。
...
- 左ツールレールには編集用の「描く」「消す」「掴む」の3つのアイコンを表示し、最下部の「新規作成」で現在の世界を残したまま空の新しい世界を開ける。共通に見える編集操作もactive layer固有のハンドラーと保存コマンドへ振り分ける
