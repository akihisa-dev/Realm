...
description: Realmの単一.realmmap SQLite、rusqlite schema・migration・transaction、Tauri command、path検証、atomic create、open・save・close、破損・旧形式・future schema拒否を追加・修正する。保存形式、IPC、ファイル安全性に使い、地物仕様はrealm-change-mapを併用する。
---
