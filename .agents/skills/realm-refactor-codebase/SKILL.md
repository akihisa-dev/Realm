...
description: Realm全体または複数境界を、現行動作と.realmmap互換性を保ちながら、責務、依存方向、状態所有、Electron IPC、Node SQLite、OpenLayers、非同期、I/O、再描画、検証、正本文書まで包括的に整理する。大規模refactorや技術的負債の包括解消に使い、機能追加や単一file整理だけには使わない。
---
...
3. React、map adapter、backend、Electron IPC、domain、Node SQLiteの依存方向を整理する。
...
7. TypeScript、coverage、architecture、Node/Electron test、SBOM、docsを確認する。
