...
5. 実ユーザーの.realmmapをtest、fixture、Gitへ使わず、一時領域の合成dataだけを使う。
6. local-only、macOS arm64、単一SQLite、手動編集、年履歴、生成なしを守る。
7. 秘密情報、個人情報、内部URL、ローカル絶対pathを成果物とcommitへ含めない。
8. 完了前に最新指示、全差分、test、docs、未実施操作を照合する。
9. commitは全作業と検証後、最終報告直前だけrealm-commitへ渡す。
