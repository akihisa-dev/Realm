...
4. verify local releaseをmacOS arm64で完了し、build済みappを起動せず、DMG、bundle構造、checksum、notices、SBOMを静的に確認する。
...
8. 起動が必要な機能testはRelease成果物で行わず、明示された別工程でrealm-test-development-appを使う。
9. 署名、公証、自動更新、store配布、資格情報を推測で追加しない。
10. version、commit、tag、検証、asset、remote、公開状態を報告する。
