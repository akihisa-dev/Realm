...
Realmは、Apple Silicon搭載macOS向けのローカル地図エディタです。
各世界の階層レイヤーと、そこに描いた地形、領域、オブジェクトを、クラウドアカウントや生成データセットではなく、アプリが管理するライブラリに保存します。
...
Realmは、Apple Silicon搭載macOS向けのローカル地図エディタです。
任意の階層レイヤーへ地形、領域、都市、テキスト、森、山を描き、アプリ内ライブラリへ自動保存します。
