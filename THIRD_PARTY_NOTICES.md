...
Realm itself is licensed under [AGPL-3.0-or-later](LICENSE). This file is the starting notice for dependencies that are part of the intended 0.1.0 stack. It is not a substitute for reviewing the exact lockfiles and license texts used in a release.
